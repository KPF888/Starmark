...
星痕目前使用多个空间测绘、DNS爆破、vt查杀、证书、爬虫递归5个部分作为数据来源，对域名、IP、敏感信息等进行一键化收集操作，为前期资产收集提供极大便利。

| :information_source: **项目状态**                                                                                                              |
| --------------------------------------------------------------------------------------------------------------------------------------- |
| **重要通知：由于作者备考研究生，本项目将暂停更新维护一年，预计2026年恢复更新。感谢大家的理解与支持。**                                  |
